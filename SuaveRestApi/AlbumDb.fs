...
module MusicStoreDb = 
    ...
    //type private Sql = SqlDataProvider<ConnectionString = "Server=localhost;Database=SuaveMusicStore;Trusted_Connection=True;MultipleActiveResultSets=true;Integrated Security=SSPI;", DatabaseVendor=Common.DatabaseProviderTypes.MSSQLSERVER >
    let [<Literal>] connectionString = "Data Source=(localdb)\mssqllocaldb;Initial Catalog=SuaveMusicStore;Integrated Security=True" //"Server=localhost;Database=SuaveMusicStore;Trusted_Connection=True;MultipleActiveResultSets=true;Integrated Security=SSPI;"
